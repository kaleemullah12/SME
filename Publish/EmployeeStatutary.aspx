<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeStatutary.aspx.cs" Inherits="SMEForm.EmployeeStatutary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="ui-widget-content" style="padding:5px">
        Add New Statutary From <asp:TextBox ID="txtFromDate" runat="server" Text="" Width="100px" CssClass="textBoxDate" required="required"></asp:TextBox>
        &nbsp;To <asp:TextBox ID="txtToDate" runat="server" Text="" Width="100px" CssClass="textBoxDate" required="required"></asp:TextBox>
        &nbsp;<asp:Button ID="btnCreateNew" runat="server" Text="Add Statutary" OnClick="btnCreateNew_Click" />
    </div>
    <div class="ui-widget-content" style="padding:5px">
