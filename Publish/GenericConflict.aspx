<%@ Page Title="" Language="C#" MasterPageFile="~/Import.master" AutoEventWireup="true" CodeBehind="GenericConflict.aspx.cs" Inherits="SMEForm.GenericConflict" %>
    ...
    <div class="ui-widget-content pageContent fullHeightContent" >
        ...
        <div id="navmenu" class="menu">
                <ul>
                    ...
                    <li><a href="<%=ResolveClientUrl("~/GenericConflict.aspx")%>" title="Conflict">Conflict</a></li>
                </ul>
            </div>
        ...
        <asp:GridView ID="GVImports" runat="server" Width="100%" CssClass="jsDataTable" AllowSorting="true" AllowPaging="true" DataKeyNames="ID"
                ...
                onrowdatabound="GVImports_RowDataBound" PageSize="25" OnPageIndexChanging="GVImports_PageIndexChanging" OnSorting="GVImports_Sorting">
