...
namespace SMEForm
{
    public partial class HolidaysConflict : System.Web.UI.Page
    {
                ...
                try
                {
                    ...
                    if (dt != null)
                    {
                        foreach (DataRow item in dt.Rows)
                        {
                            ...
                            if (WorkID > 0 && FromDate != null && ToDate != null && CreatedBy!=null)
                            {
                                DeleteExistWorkId(WorkID, FromDate, ToDate,CreatedBy);
                            }
        ...
        public void DeleteExistWorkId(int workID, string FromDate, string ToDate,string CreatedBy)
        {
        ...
        void BindGV()
        {
            var imports = DbContext.Current().Holiday_Conflict.ToList();
