<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeVacation.aspx.cs" Inherits="SMEForm.EmployeeVacation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ui-widget-header pageHeader" >
        Student Vacation
        &nbsp;<asp:HyperLink ID="lkDetail" runat="server" Text="Employee Details"></asp:HyperLink>
    </div>
    <div class="ui-widget-content" style="padding:5px">
        Add New vacation from <asp:TextBox ID="txtFromDate" runat="server" Text="" Width="100px" CssClass="textBoxDate"></asp:TextBox>
        &nbsp;To <asp:TextBox ID="txtToDate" runat="server" Text="" Width="100px" CssClass="textBoxDate"></asp:TextBox>
        &nbsp;<asp:Button ID="btnCreateNew" runat="server" Text="Add vacation" OnClick="btnCreateNew_Click" />
    </div>
    <div class="ui-widget-content ui-corner-bottom pageContent fullHeightContent" >
        <asp:GridView ID="gvVacations" runat="server" DataKeyNames="ID" Width="100%" AutoGenerateColumns="false" OnRowCancelingEdit="gvHolidays_RowCancelingEdit" OnRowDeleting="gvHolidays_RowDeleting" OnRowEditing="gvHolidays_RowEditing" OnRowUpdating="gvHolidays_RowUpdating">
